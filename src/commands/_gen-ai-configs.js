...
function run(projectDir, mode, force) {
  ...
  var claudeContent = [
    ...
    '- NEVER proceed past Plan without `Plan Approved By:` and `Approved At:` being filled.',
  ...
  var cursorContent = [
    ...
    'RULE: Plan Approved By and Approved At must be filled before Execute phase.',
  ...
  var copilotContent = [
    ...
    '- Plan Approved gate: do not suggest implementation code until `Plan Approved By:` and `Approved At:` are filled.',

...
## Entry Commands
- sdd discover <dir> --task-name <name> ... = start a new task / Pre-Research
...
RULE: Never write code without an approved Spec in mydocs/specs/
RULE: RIPER phases are Pre-Research → Research → Innovate → Plan → Execute → Review

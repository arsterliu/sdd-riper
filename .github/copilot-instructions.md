...
- Plan Gate 只由 `APPROVAL_POLICY=agent|human` 控制。agent approval 使用 `Plan Approved By: agent:<id>`、`Approved At:` 和 `Gate Evidence:`；human approval 使用 `Plan Approved By: human:<name>`。
